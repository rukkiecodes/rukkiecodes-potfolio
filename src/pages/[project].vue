<template>
  <v-container style="margin-top: 40vh;">
      ...
      <v-col cols="12">
        ...
        >
          <p class="font-weight-bold text-h5 text-sm-h4 text-md-h3 text-lg-h2">work(<span
            class="text-indigo-accent-4 font-weight-light">'{{ projectData?.title }}'</span>)</p>
    ...
    <v-card
      ...
      class="mb-16"
    >
      <p class="font-weight-bold text-h6 text-sm-h5 text-md-h4 text-lg-h3 mt-16 mb-5">Overview</p>
      <p
      ...
      <p class="font-weight-bold text-h6 text-sm-h5 text-md-h4 text-lg-h3 mt-16 mb-5">About {{ projectData?.title }}</p>
      <p
